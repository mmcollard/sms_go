...
@Component({
  ...
  imports: [RouterOutlet, HeaderComponent, CardPublicacionComponent, BotonesComponent, BarraLateralComponent, BarraLateralDerechaComponent, RouterLinkActive, RouterLink]
})
